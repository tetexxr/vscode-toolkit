...
import {
  ...
  findCursorPosition,
  buildTemplate
} from '../../../../src/features/codegen/csharp/csharp-template'
import { BuildTemplateOptions } from '../../../../src/features/codegen/csharp/csharp-types'
...
describe('toFileScopedNamespace', () => {
  ...
  it('should work with 2-space indentation', () => {
    const input = ['namespace MyApp', '{', '  public class Foo', '  {', '  }', '}'].join('\n')
    const expected = ['namespace MyApp;', '', 'public class Foo', '{', '}'].join('\n')
