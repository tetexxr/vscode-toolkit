...
import {
  ...
  pascalCase,
  singularize
} from '../../src/features/json-to-type-utils'
...
describe('inferSchema', () => {
  ...
  it('distinguishes integer from float numbers', () => {
  ...
  it('marks integers exceeding Int32 as large', () => {
  ...
  it('merges null elements into nullable arrays', () => {
...
describe('mergeSchemas for objects', () => {
  it('marks fields missing from one side as optional', () => {
  ...
  it('marks fields present-but-null in one shape as nullable', () => {
    const a = inferSchema({ id: 1, name: 'a' })
...
describe('generateTypeScript', () => {
  it('emits an interface for the root and nested objects', () => {
  ...
  it('marks merged-missing fields as optional', () => {
  ...
  it('singularizes nested array item names', () => {
  ...
  it('treats array of unknown as unknown[]', () => {
    const schema = inferSchema({ items: [] })
    const out = generateTypeScript(schema, 'Root', DEFAULT_TS_OPTIONS)
    assert.match(out, /items: unknown\[\]/)
  })

  it('emits parenthesized union for nullable element arrays', () => {
...
describe('generateCSharp', () => {
  it('emits a positional record for the root and nested objects', () => {
    const schema = inferSchema({
      id: 1,
      name: 'Alice',
      tags: ['admin', 'user'],
  ...
  it('emits a class with auto-properties when output kind is class', () => {
    const schema = inferSchema({ id: 1, name: 'a' })
  ...
  it('emits records with declared properties when configured', () => {
    const schema = inferSchema({ id: 1 })
  ...
  it('supports List<T> collection wrapper', () => {
  ...
  it('supports array collection wrapper', () => {
