...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  { category: 'Workspace', name: 'REST Client', command: 'toolkit.restClient.send', description: 'Run .http requests; rich response panel with live timer/cancel and retry-on-timeout, environments (with a scaffoldable gitignored private overlay), variables, file bodies, copy as curl' },
