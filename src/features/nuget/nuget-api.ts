...
import {
  ApiIndexResponse, ApiResource,
  SearchResults, SearchResultPackage,
  RegistrationIndex, RegistrationPage, RegistrationLeaf, CatalogEntry,
  PackageSource, PackageViewModel, InstalledPackage,
} from './nuget-types';
...
export async function fetchPackageVersions(
  packageId: string, prerelease: boolean, source: PackageSource, timeout: number,
