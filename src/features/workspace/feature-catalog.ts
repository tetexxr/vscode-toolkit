...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  { category: 'Workspace', name: 'Word Bookmarks', command: 'toolkit.docx.checkWorkspace', description: 'Scan .docx templates for bookmark problems — chiefly a placeholder split across runs, which breaks first-run replacement, plus duplicate names, orphans and over-long names — and consolidate the fixable ones in place, keeping formatting' },
