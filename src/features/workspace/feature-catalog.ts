...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  { category: 'Git', name: 'Commit & Push — Selected Repos', command: 'toolkit.git.commitPushAllRepos', description: "One commit message + push across every selected repo's staged changes; button in the Source Control title bar. Commit-only variant available" },
