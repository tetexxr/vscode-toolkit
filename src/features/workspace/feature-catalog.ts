...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  { category: 'Workspace', name: 'PDF Fields', command: 'toolkit.pdf.inspectFields', description: 'Inspect the AcroForm fields of a PDF in a panel (name, type, current value) and selectively clear the ones holding a value, overwriting the file in place' },
