...
export const FEATURE_CATALOG: FeatureEntry[] = [
  ...
  { category: 'Workspace', name: 'Resource Translations', command: 'toolkit.resx.checkWorkspace', description: 'Keep .resx localization groups in sync: missing-key/order/duplicate/placeholder diagnostics, quick fixes, group sync and a Resources sidebar with per-language completeness' },
