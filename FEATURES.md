...
| PDF Fields | — | Inspect a PDF form's AcroForm fields in a panel — name, type and current value — and selectively clear the fields that hold a value, overwriting the PDF in place. From the palette (pick a PDF) or the explorer context menu on a .pdf |
