...
| REST Response History | — | Sidebar tree of recent .http responses grouped by request; color-coded status, re-send, diff, detail panel, copy as curl/body/URL, save body, go to source |
